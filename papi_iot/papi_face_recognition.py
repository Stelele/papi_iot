...
class PapiFaceRecognition:
    ...
    VIDEO = cv2.VideoCapture('./home/pi/videos/facerecvideo.mp4') # Could put in a video file or path to video file/stream from camera
    ...
    def __init__ (self):
        ...
        self.MODEL = 'cnn'
        self.VIDEO = cv2.VideoCapture('./home/pi/videos/facerecvideo.mp4')
        ...
        while True:
            ...
            for face_encoding, face_location in zip(encodings, locations):
                ...
                if True in results:  # If at least one is true, get a name of first of found labels
                    ...
                    pickle.dump(face_encoding, open(f"{self.KNOWN_FACES_DIR}/{match}/{match}-{int(time.time())}.plk", "wb"))
